...
if (b == 69 && Damage == 0)
  {
	setTile (x,y,z,69,1)
	TestDust (x-1,y,z,power)
	TestDust (x+1,y,z,power)
	TestDust (x,y,z-1,power)
	TestDust (x,y,z+1,power)
	TestDust (x,y-2,z,power)
  }
if (b == 69 && Damage == 1)
  {
	setTile (x,y,z,69,0)
	TestDust (x-1,y,z,unpower)
	TestDust (x+1,y,z,unpower)
	TestDust (x,y,z-1,unpower)
	TestDust (x,y,z+1,unpower)
	TestDust (x,y-2,z,unpower)
  }
}
...
if (getTile (x,y,z) == 55 && mode)
  {
	...
	TestDust (x,y,z-1,power)
	TestDust (x,y,z+1,power)
	TestDust (x-1,y-1,z,power)
	TestDust (x+1,y-1,z,power)
	TestDust (x,y-1,z-1,power)
	TestDust (x,y-1,z+1,power)
	TestDust (x-1,y+1,z,power)
	TestDust (x+1,y+1,z,power)
	TestDust (x,y+1,z-1,power)
...
if (getTile (x,y,z) == 100 && !mode)
  {
	...
	TestDust (x,y,z-1,unpower)
	TestDust (x,y,z+1,unpower)
	TestDust (x-1,y-1,z,unpower)
	TestDust (x+1,y-1,z,unpower)
	TestDust (x,y-1,z-1,unpower)
	TestDust (x,y-1,z+1,unpower)
	TestDust (x-1,y+1,z,unpower)
	TestDust (x+1,y+1,z,unpower)
	TestDust (x,y+1,z-1,unpower)
