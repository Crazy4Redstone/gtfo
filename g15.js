...
Block.defineBlock (70,"Stone Pressure Plate",[["stone",0]],19,false,13)
...
function TestDust (x,y,z,state)
{
if (getTile (x,y,z) == 55 && state)
  {
    	setTile (x,y,z,100)
	TestDust (x-1,y,z,true)
	TestDust (x+1,y,z,true)
...
y = getPlayerY()
z = getPlayerZ()
var cpp = getTile (x,y-1.6,z)
var pd = Level.getData (x,y,z)
if (cpp == 70 && pd == 0) 
  {
	setTile (x,y-1.6,z,70,1)
	TestDust (x-1,y-1,z,true)
	TestDust (x+1,y-1,z,true)
	TestDust (x,y-1,z-1,true)
	TestDust (x,y-1,z+1,true)
